...
const SettingsView = ({ onBack }: SettingsViewProps) => {
  ...
  return (
    <div className="flex-1 bg-[#111111] p-6 flex flex-col items-center justify-center">
      ...
      <div className="max-w-2xl space-y-6 w-full">
        ...
        <div className="bg-[#161616] rounded-lg border border-[#222222] p-6">
          ...
          <h2 className="text-sm font-small text-white mb-6">Go to trello.com/power-ups/admin/ to get this information.</h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-gray-400 mb-2">Token (Not Secret)</label>
              <input
                type="password"
                value={token}
      ...
      <div className="text-center text-gray-500 mt-8">v1.0.1</div>
    </div>
  );
};
