...
const BoardsList = ({ onSelectBoard }: { onSelectBoard: (boardId: string) => void }) => {
  ...
  const createBoard = async () => {
    ...
    try {
      ...
      const columnsRef = collection(db, `users/${user.uid}/boards/${newBoard.id}/columns`);
      ...
      const defaultColumns = [
        { 
          ...
          cards: [{
            ...
            description: 'This is a card. You can edit it, move it, or delete it. Click the + button below to add more cards to this column.',
            createdAt: Timestamp.now(),
            order: 0
          }], 
          order: 0 
        ...
        { 
          ...
          cards: [{
            id: uuidv4(),
            title: 'Cards can be dragged between columns',
        ...
        { 
          ...
          cards: [{
            id: uuidv4(),
            title: 'Columns can be reordered too',
            description: 'Drag the column header to reorder your columns.',
            createdAt: Timestamp.now(),
            order: 0
          }], 
          order: 2 
